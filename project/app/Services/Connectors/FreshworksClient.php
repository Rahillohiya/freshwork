...
class FreshworksClient
{
    ...
    {
        $this->certificate_file = $certificate_file?$certificate_file:realpath(__DIR__.'/../../../../certificates/cacert.pem');
    ...
    public function generateAccessTokenHeader($access_token)
    {
    ...
    public function getAuthorizationURL($authorizationRequestUrl, $scope, $redirect_uri, $response_type, $state,$channel_id=16)
    {
        $parameters = array(
