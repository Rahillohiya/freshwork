    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['webhook_event_id'=>1,'topic_name'=>'carts/create',
                'webhook_topic_url'=>'process_shopify_webhooks','topic_status'=>'enabled'],
            ...
            ['webhook_event_id'=>9,'topic_name'=>'fulfillment_events/create','webhook_topic_url'=>
                'process_shopify_webhooks','topic_status'=>'enabled'],
            ['webhook_event_id'=>9,'topic_name'=>'fulfillment_events/delete','webhook_topic_url'=>'process_shopify_webhooks','topic_status'=>'enabled'],

            ['webhook_event_id'=>10,'topic_name'=>'inventory_items/create','webhook_topic_url'=>'process_shopify_webhooks','topic_status'=>'enabled'],
            ['webhook_event_id'=>10,'topic_name'=>'inventory_items/update','webhook_topic_url'=>'process_shopify_webhooks','topic_status'=>'enabled'],
            ['webhook_event_id'=>10,'topic_name'=>'inventory_items/delete','webhook_topic_url'=>'process_shopify_webhooks','topic_status'=>'enabled'],


            ['webhook_event_id'=>11,'topic_name'=>'inventory_levels/connect','webhook_topic_url'=>'process_shopify_webhooks','topic_status'=>'enabled'],
            ['webhook_event_id'=>11,'topic_name'=>'inventory_levels/update','webhook_topic_url'=>'process_shopify_webhooks','topic_status'=>'enabled'],
            ['webhook_event_id'=>11,'topic_name'=>'inventory_levels/disconnect','webhook_topic_url'=>'process_shopify_webhooks','topic_status'=>'enabled'],

            ['webhook_event_id'=>12,'topic_name'=>'locations/create','webhook_topic_url'=>'process_shopify_webhooks','topic_status'=>'enabled'],
            ['webhook_event_id'=>12,'topic_name'=>'locations/update','webhook_topic_url'=>'process_shopify_webhooks','topic_status'=>'enabled'],
            ['webhook_event_id'=>12,'topic_name'=>'locations/delete','webhook_topic_url'=>'process_shopify_webhooks','topic_status'=>'enabled'],
            ...
            ['webhook_event_id'=>18,'topic_name'=>'shop/update','webhook_topic_url'=>'process_shopify_webhooks','topic_status'=>'enabled'],
