        ...
        <div class="container">
            <div class="section-main-heading">
                ...
                <ul class="faq-list">
                    ...
                    <li>
                        <div class="question">
                            <span>What is connectify and how does it work?</span>
                        </div>
                        <div class="answer">

                            <p><strong>Connectify</strong> is an automation tool that auto triggers all shopify store
                                events
                                and send to 3rd party platforms with simplicity and easy. You can connect your shopify
                                stores with Google Sheets and Slack without coding or relying on developers to build the
                                integration.</p>
                            <p>Simply register any event from Webhook Setup page by clicking Connect Button next to
                                ...
                                save.E-g
                                trigger all your new orders to your google sheets shared with your vendors.</p>
                        </div>
                    </li>
                    <li>
                        <div class="question">
                        ...
                        <div class="answer">
                            <p>
                                ...
                                store and connectify. They can include errors and warnings as well as informational
                                events.E-g
                            </p>
                            <ul class="privacy-bullet-points">
                                <li>New order successfully triggered to your slack channel.
                                </li>
                                <li>Product has been updated into your google sheets.
                                </li>
                            </ul>
                    ...
                    <li>
                        ...
                        <div class="answer">
                            <p>If error is related to any connector or channel like google sheets/slack, copy and paste
                                the
                    ...
                    <li>
                        ...
                        <div class="answer">
                            <p>You can apply filters and set conditions on events for particular channels.For
                                example,</p>
                            <ul class="privacy-bullet-points">
                                <li>You can post all orders placed on particular date to Google Sheet A.</li>
                                <li>Forward orders with amount greater than $100 to sheet B.</li>
                                <li>Trigger products tagged with particular vendor to slack channels.</li>
                            </ul>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        <div class="question">
                            <span>Data privacy at Connectify</span>
                        </div>
                        <div class="answer">

                            <p>We take the security of your credentials and data very seriously.</p>
                            <ul class="privacy-bullet-points">
                                <li>Credentials that you use to connect your accounts to Connectify are protected with
                                ...
                                <li>
                                    Account access credentials (like API keys for Twilio, smtp credentials from
                                    mail,tokens for Salesforce,Hubspot, and passwords for database channels like mysql)
                                    saved by Connectify are encrypted with AES-256-CBC cipher and stored in a database.
                                    Of course, Connectify has the decryption keys on hand so we can use the credentials
                    ...
                    <li>
                        <div class="question">
                            <span>What is [ ] sign in shopify variables and how arrays are handled in connectify?</span>
                        </div>
                        <div class="answer">
                            <p>We take the security of your credentials and data very seriously.</p>
                            <ul class="privacy-bullet-points">
                    ...
                    <li>
                        ...
                        <div class="answer">
                            ...
                            <p>Some connectors like freshworks support multiple line items in some of their
