                                    ...
                                    <div class="plans row">
                                        <div class="col-md-4 col-sm-6 col-12 mt-mobile">
                                            <div class="plan basic <?= $classes['basic'] ?>">
                                                ...
                                                <ul class="plan-features">
                                                    <li><i class="ion-checkmark"> </i>2 Channels</li>
                                            ...
                                            <div class="plan professional <?= $classes['professional'] ?>">
                                                ...
                                                <div class="box">
                                                    <header>
                                                        ...
                                                        <div class="plan-cost">
                                                            <span class="sup">$</span>
                                                            <span class="plan-price">{{ env('Premium_Plan_PRICE', 19) }}</span>
                                                            <span class="plan-type">/month</span>
                                                            <div class="muted">USD Billed Monthly </div>
                                                        </div>
                                                    </header>
                                                ...
                                                <ul class="plan-features">
                                                    <li><i class="ion-checkmark"> </i>6 Channels</li>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-12 mt-mobile">
                                            <div class="plan elite <?= $classes['elite'] ?>">
                                                <div class="ribbon ribbon-top-right"><span>Featured</span></div>
                                                    <div class="box">
                                                        <header>
                                                            ...
                                                            <div class="plan-cost">
                                                                <span class="sup">$</span>
                                                                <span class="plan-price">{{ env('Elite_Plan_PRICE', 29) }}</span>
                                                                <span class="plan-type">/month</span>
                                                                <div class="muted">USD Billed Monthly </div>
                                                            </div>
                                                        </header>
                                                ...
                                                <ul class="plan-features">
                                                    <li><i class="ion-checkmark"> </i>All Channels</li>
