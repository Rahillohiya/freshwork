...
<div class="MainWrapper">
    <div class="container">
        ...
        <div class="bodyContent">
            <div class="bodyText">
                <h2>Hey {{ ucwords(str_replace('_', ' ', str_replace('-', ' ', $shop->name))) }}!</h2>
                <ul>
                    <li>This email notification is just to inform you that Shopify has updated its event payload. To continue enjoying the smooth automation process we highly recommend to please update the required changes in registered webhook data. Click the <a href="{{ $link }}">Notification</a> to perform the updates.</li>

                    <li>Have questions? Feel free to reach out to our support team via email, or Live chat for any help.</li>
