<div class="connector-setup-page-section">
    ...
    <div class="Create-Refund-Receipt-parent-div">
        <div class="fields-wrapper">
            ...
            <div class="form-group">
                <input class="ExpenseAccountRef" data-rule-required="true" data-msg-required=" "
            ...
            <span>
          Specifies the account reference. Check must specify bank account, AccountType must be Other Current Asset or Bank. </span>
            </div>
        </div>
        <div class="fields-wrapper">
            <div class="Polaris-Labelled__LabelWrapper">
        ...
        <div class="fields-wrapper">
            <div class="Polaris-Labelled__LabelWrapper">
                <div class="Polaris-Label right-required-text-label">
                    <label id="PolarisTextField2Label"
                           for="PolarisTextField2"
                           class="Polaris-Label__Text"> Refund Receipt Transaction Date
                        <span></span>
                    </label>
                </div>
            </div>
        ...
        <div class="fields-wrapper">
            <div class="Polaris-Labelled__LabelWrapper">
                <div class="Polaris-Label right-required-text-label">
                    <label id="PolarisTextField2Label"
                           for="PolarisTextField2"
                           class="Polaris-Label__Text"> Check or Payment Reference Number
                        <span></span>
                    </label>
                </div>
            </div>
            ...
            <div class="Polaris-Labelled__HelpText">
                <span>The reference number for the payment received. For example, check # for a check, envelope # for a cash donation.Required when PrintStatus is set to PrintComplete.</span>
            </div>
        </div>
        ...
        <div class="interlink-fields">
            ...
            <div class="fields-wrapper">
                ...
                <div class="form-group">
                    <input class="ItemRef" data-rule-required="true" data-msg-required=" "
            ...
            <div class="fields-wrapper">
                ...
                <div class="Polaris-Connected">
                    <div class="Polaris-Connected__Item Polaris-Connected__Item--primary ">
                        <div class="input-field-selection-textarea rich_textarea msg-body-style"
                             contenteditable="true">{{ old('api_fields[SalesItemLineDetail][Description]')?old('api_fields[SalesItemLineDetail][Description]'):$api_fields['SalesItemLineDetail']['Description']??'' }}</div>
                        <textarea class="hidden_rich_textarea"
                                  name="api_fields[SalesItemLineDetail][Description]"
                                  style="display: none;">{{ old('api_fields[SalesItemLineDetail][Description]')?old('api_fields[SalesItemLineDetail][Description]'):$api_fields['SalesItemLineDetail']['Description']??'' }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="fields-wrapper">
                ...
                <div class="Polaris-Connected">
                    <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                        ...
                        <textarea class="hidden_rich_textarea"
                                  data-msg-required="Please enter unit price."
                                  data-rule-required="true"
                                  data-rule-zeroWideSpace="true"
